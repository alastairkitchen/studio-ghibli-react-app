...
import {
  createFilmPanelData,
  createPersonPanelData
} from "./helpers/studio-ghibli-helper";
// owned imports
  ...
  render() {
    return (
      <div>
        ...
        <section className="content-section content-section--orange">
        ...
        <article className="container">
          <div className="row">
            ...
            <p>
              list of characters from studio ghibli films lorem ipsum dolar
              summet
            </p>
